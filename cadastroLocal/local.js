        ...
        .then(local => {
              local.forEach(function(local, index) {
                  ...
                  cardBody.innerHTML = `
                      ...
                      <button href="../index.html/#Mapa" id="corB2${index + 1}" class="btn mt-3 text-light fw-bold rounded-4">Veja Mais <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
